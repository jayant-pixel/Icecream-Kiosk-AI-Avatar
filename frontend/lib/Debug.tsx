...
export const useDebugMode = ({ logLevel }: { logLevel?: LogLevel }) => {
  ...
  React.useEffect(() => {
    ...
    const datadogSite = process.env.NEXT_PUBLIC_DATADOG_SITE as
      | Parameters<typeof datadogLogs.init>[0]["site"]
      | undefined;

    if (process.env.NEXT_PUBLIC_DATADOG_CLIENT_TOKEN && datadogSite) {
